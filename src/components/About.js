    ...
    <Grid container item justifyContent='center'>
      <Grid container item direction='column' xs={11} md={7} gap={2} textAlign='center'>
        ...
        <Typography variant="body1">
          If you'd like to learn more about my background, <Link color='primary' fontWeight={700} sx={{ textDecoration: 'none' }} href="https://drive.google.com/uc?export=view&id=1MX4ZWU4RNRpj3mL2C9uz_dYX0p7O8GvX" >check out my resume!</Link>
        </Typography>
        </Stack>
        </motion.div>
      </Grid>
